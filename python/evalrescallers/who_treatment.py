...
class DstProfile:
    def __init__(self, drug_to_pheno, regimen_year):
        ...
        self.regimen_year = regimen_year
        if self.regimen_year == 2017:
            self._set_regimen_2017()
        elif self.regimen_year == 2018:
            self._set_regimen_2018()
        else:
            raise RuntimeError(f'regimen_year must be 2017 or 2018 but got {regimen_year}')


    def _set_regimen_2017(self):
        regimens = regimens_2017
        first_line_tuple = (
    ...
    def _set_regimen_2018(self):
        regimens = regimens_2018
        first_line_tuple = (
            self.phenos['Isoniazid'],
            self.phenos['Rifampicin'],
            self.phenos['Pyrazinamide'],
